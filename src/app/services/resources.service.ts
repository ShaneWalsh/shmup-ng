...
export class ResourcesService {
    ...
    constructor ( ) {
      ...
      this.resourcesToLoad = [
        ...
        {code:"boss-explosion-2", path:"src/assets/img/bots/explosion/boss-explosion-2.png", type:ResourcesEnum.ImageRes},
        {code:"boss-explosion-3", path:"src/assets/img/bots/explosion/boss-explosion-3.png", type:ResourcesEnum.ImageRes},
        {code:"boss-explosion-4", path:"src/assets/img/bots/explosion/boss-explosion-4.png", type:ResourcesEnum.ImageRes},
        {code:"boss-explosion-5", path:"src/assets/img/bots/explosion/boss-explosion-5.png", type:ResourcesEnum.ImageRes},
        {code:"boss-explosion-6", path:"src/assets/img/bots/explosion/boss-explosion-6.png", type:ResourcesEnum.ImageRes},
        {code:"boss-explosion-7", path:"src/assets/img/bots/explosion/boss-explosion-7.png", type:ResourcesEnum.ImageRes},
        {code:"boss-explosion-8", path:"src/assets/img/bots/explosion/boss-explosion-8.png", type:ResourcesEnum.ImageRes},
        {code:"boss-explosion-9", path:"src/assets/img/bots/explosion/boss-explosion-9.png", type:ResourcesEnum.ImageRes},
        {code:"boss-explosion-10", path:"src/assets/img/bots/explosion/boss-explosion-10.png", type:ResourcesEnum.ImageRes},
        ...
        {code:"level-3-bg-2", path:"assets/img/levels/level-3-update/level-3-bg-2.png", type:ResourcesEnum.ImageRes},
          ...
          {code:"options-arrow", path:"assets/img/hud/Options-Arrow.png", type:ResourcesEnum.ImageRes},
          ...
          {code:"alt-scene-2-1", path:"assets/img/loading/intro2/alt-scene-2/alt-scene-2-1.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-2-2", path:"assets/img/loading/intro2/alt-scene-2/alt-scene-2-2.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-2-3", path:"assets/img/loading/intro2/alt-scene-2/alt-scene-2-3.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-2-4", path:"assets/img/loading/intro2/alt-scene-2/alt-scene-2-4.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-2-5", path:"assets/img/loading/intro2/alt-scene-2/alt-scene-2-5.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-2-6", path:"assets/img/loading/intro2/alt-scene-2/alt-scene-2-6.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-2-7", path:"assets/img/loading/intro2/alt-scene-2/alt-scene-2-7.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-2-8", path:"assets/img/loading/intro2/alt-scene-2/alt-scene-2-8.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-2-9", path:"assets/img/loading/intro2/alt-scene-2/alt-scene-2-9.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-2-10", path:"assets/img/loading/intro2/alt-scene-2/alt-scene-2-10.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-2-11", path:"assets/img/loading/intro2/alt-scene-2/alt-scene-2-11.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-2-12", path:"assets/img/loading/intro2/alt-scene-2/alt-scene-2-12.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-2-13", path:"assets/img/loading/intro2/alt-scene-2/alt-scene-2-13.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-2-14", path:"assets/img/loading/intro2/alt-scene-2/alt-scene-2-14.png", type:ResourcesEnum.ImageRes},

          {code:"alt-scene-3-1", path:"assets/img/loading/intro2/alt-scene-3/alt-scene-3-1.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-3-2", path:"assets/img/loading/intro2/alt-scene-3/alt-scene-3-2.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-3-3", path:"assets/img/loading/intro2/alt-scene-3/alt-scene-3-3.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-3-4", path:"assets/img/loading/intro2/alt-scene-3/alt-scene-3-4.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-3-5", path:"assets/img/loading/intro2/alt-scene-3/alt-scene-3-5.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-3-6", path:"assets/img/loading/intro2/alt-scene-3/alt-scene-3-6.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-3-7", path:"assets/img/loading/intro2/alt-scene-3/alt-scene-3-7.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-3-8", path:"assets/img/loading/intro2/alt-scene-3/alt-scene-3-8.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-3-9", path:"assets/img/loading/intro2/alt-scene-3/alt-scene-3-9.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-3-10", path:"assets/img/loading/intro2/alt-scene-3/alt-scene-3-10.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-3-11", path:"assets/img/loading/intro2/alt-scene-3/alt-scene-3-11.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-3-12", path:"assets/img/loading/intro2/alt-scene-3/alt-scene-3-12.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-3-13", path:"assets/img/loading/intro2/alt-scene-3/alt-scene-3-13.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-3-14", path:"assets/img/loading/intro2/alt-scene-3/alt-scene-3-14.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-3-15", path:"assets/img/loading/intro2/alt-scene-3/alt-scene-3-15.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-3-16", path:"assets/img/loading/intro2/alt-scene-3/alt-scene-3-16.png", type:ResourcesEnum.ImageRes},

          {code:"alt-scene-4-1", path:"assets/img/loading/intro2/alt-scene-4/alt-scene-4-1.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-4-2", path:"assets/img/loading/intro2/alt-scene-4/alt-scene-4-2.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-4-3", path:"assets/img/loading/intro2/alt-scene-4/alt-scene-4-3.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-4-4", path:"assets/img/loading/intro2/alt-scene-4/alt-scene-4-4.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-4-5", path:"assets/img/loading/intro2/alt-scene-4/alt-scene-4-5.png", type:ResourcesEnum.ImageRes},
          {code:"alt-scene-4-6", path:"assets/img/loading/intro2/alt-scene-4/alt-scene-4-6.png", type:ResourcesEnum.ImageRes},
