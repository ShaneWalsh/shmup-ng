...
export class BotManagerService {
  ...
  generateDrone(levelInstance: LevelInstance, randomPosition: boolean = true, posX: number = 0, posY: number = -60, config: any = {}): any {
    ...
    this.resourcesService.getRes().get("enemy-2-2"), 56, 78,new HitBox(0, 0, 56, 78),this.resourcesService.getRes().get("enemy-2-1-old-damaged"));
  ...
  generateLevel3SubBoss(levelInstance: LevelInstance, randomPosition: boolean = true, posX: number = 0, posY: number = -300, config: any = {}): any {
    ...
    let newBot = new Level3SubBoss(config, posObj.posX, posObj.posY,
      ...
      480,
      640,
      [this.resourcesService.getRes().get("laser-1"),this.resourcesService.getRes().get("laser-2"),this.resourcesService.getRes().get("laser-3")],
      [this.resourcesService.getRes().get("laser-4"),this.resourcesService.getRes().get("laser-5"),this.resourcesService.getRes().get("laser-6"),
        this.resourcesService.getRes().get("laser-7"),this.resourcesService.getRes().get("laser-8"),this.resourcesService.getRes().get("laser-9")],
      [this.resourcesService.getRes().get("laser-10"),this.resourcesService.getRes().get("laser-11")],
  ...
  generateLevel3SubBoss2Bomber(levelInstance: LevelInstance, randomPosition: boolean = true, posX: number = 0, posY: number = -300, config: any = {}): any {
    ...
    let newBot = new Level3SubBoss2( config, posObj.posX, posObj.posY,
        ...
        this.resourcesService.getRes().get("boss-9-damaged"),
